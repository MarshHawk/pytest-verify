# -*- coding: utf-8 -*-
#
# pytest-verify documentation build configuration file, created by
...
project = u'pytest-verify'
copyright = u'2015, Sean Glover'
author = u'Sean Glover'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-verify Documentation',
     [author], 1)
]
